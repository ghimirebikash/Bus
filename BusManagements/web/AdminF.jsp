...
<div id="mySidenav" class="sidenav">
  ...
  <div class="profile">
  	...
  	<span class="profile-name">BIKASH GHIMIRE</span>
...
<div class="imp">
  	  ...
  	  <table class="data-table">
            ...
            <th>Edit</th>
                  ...
                  <tbody id="data">
                      ...
                      %>
  	  	  <tr>
  	  	  	 <td><% out.println(obj.getUserid());%></td>
  	  	  	 <td><% out.println(obj.getUsername());%></td>
  	  	  	 <td><% out.println(obj.getGender());%></td>
  ...
  <div class="addfaculties">
  	<form class="box" action="addfaculty" method="post">
            <h1>Add Faculties</h1>
            <i class="fa fa-times" id="cross"></i>
            <input type="radio" name="gender" value="Male"><i class="fa fa-male"></i>
            <input type="radio" name="gender" value="Female"><i class="fa fa-female"></i><br>
    ...
    <div class="tog"><a>Add Faculties<a/></div>
</div>
  <div class="footer">
      <div >
